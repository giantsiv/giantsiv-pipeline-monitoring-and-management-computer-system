...
class phpMQTT
{
    ...
    protected $username ='giannis';            /* stores username */
    protected $password = '12345';            /* stores password */
     ...
     * @return bool
     */
    public function connect($clean = false, $will = null, $username = null, $password = null): bool
    {
        if ($will) {
            $this->will = $will;
        }
